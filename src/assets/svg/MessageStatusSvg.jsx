const MessageStatusSvg = (sent) => (
  ...
  {/* left curve */}
    ...
    >
      <path
        fill={sent ? "none" : "none"}
        stroke={sent ? "#7ADB78" : "#AC6AFF"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
...
export default MessageStatusSvg;
