...
export const BottomLine = () => {
  return (
    <>
      ...
      <StarSvg className="hidden absolute top-[54.5975rem] left-[1.8875rem] z-2 pointer-events-none xl:block" />

      <StarSvg className="hidden absolute top-[54.5975rem] right-[1.8875rem] z-2 pointer-events-none xl:block" />
    </>
  );
};
    ...
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      ...
      <MouseParallax strength={0.05} enableOnTouchDevice isAbsolutelyPositioned>
        ...
        <div className="hidden lg:block absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[54deg]">
          <div
            className={`w-4 h-4 -ml-1 mt-[12.9rem] bg-gradient-to-b from-[#0097eb] to-[#1A1A32] rounded-full transit transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>

        <div className="hidden lg:block absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[65deg]">
          <div
            className={`w-3 h-3 ml-10 mt-36 bg-gradient-to-b from-[#AC6AFF] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
        ...
        <div className="hidden lg:block absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[70deg]">
          <div
            className={`w-6 h-6 ml-42 ml-0 mt-24 bg-gradient-to-b from-[#7ADB78] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
